...
let g:airline#themes#test#palette = {}
...
let g:airline#themes#test#palette.normal =
      \ airline#themes#generate_color_map(s:airline_a_normal,
                                        \ s:airline_b_normal,
                                        \ s:airline_c_normal)

let g:airline#themes#test#palette.normal['airline_z'] =
      \ [s:green['hex'], s:base03['hex'], s:green['term'], s:base03['term'],
       \ 'italic']

let g:airline#themes#test#palette.normal_modified = {
...
"                                                                   Insert Mode
" *****************************************************************************
let s:airline_a_insert = [s:base03['hex'] , s:green['hex'],
                        \ s:base03['term'], s:cyan['term'], 'italic']

let s:airline_b_insert = [s:base1['hex'],  s:base03['hex'],
                        \ s:base1['term'], s:base03['term'], 'italic']

let s:airline_c_insert = [s:cyan['hex'],  s:base03['hex'],
                        \ s:cyan['term'], s:base03['term'], 'italic']

let g:airline#themes#test#palette.insert =
      \ airline#themes#generate_color_map(s:airline_a_insert,
                                        \ s:airline_b_insert,
                                        \ s:airline_c_insert)

let g:airline#themes#test#palette.insert['airline_z'] =
      \ [s:green['hex'], s:base03['hex'], s:green['term'], s:base03['term'],
       \ 'italic']

let g:airline#themes#test#palette.insert_modified = {
      \ 'airline_c': [s:magenta['hex'],  s:base03['hex'],
                    \ s:magenta['term'], s:base03['term'], 'italic'],
      \ }

let g:airline#themes#test#palette.insert_paste = {
      \ 'airline_a': [s:base03['hex'],  s:orange['hex'],
                    \ s:base03['term'], s:orange['term'], 'italic'],
      \ }

" *****************************************************************************
"                                                                  Replace Mode
" *****************************************************************************
let g:airline#themes#test#palette.replace =
      \ copy(g:airline#themes#test#palette.insert)

let g:airline#themes#test#palette.replace.airline_a =
      \ [s:base03['hex'], s:red['hex'], s:base03['term'], s:red['term'], 'italic']

let g:airline#themes#test#palette.replace_modified =
      \ g:airline#themes#test#palette.insert_modified

" *****************************************************************************
"                                                                   Visual Mode
" *****************************************************************************
let s:airline_a_visual = [s:base03['hex'],  s:green['hex'],
                        \ s:base03['term'], s:yellow['term'], 'italic']

let s:airline_b_visual = [s:base1['hex'],  s:base03['hex'],
                        \ s:base1['term'], s:base03['term'], 'italic']

let s:airline_c_visual = [s:cyan['hex'],  s:base03['hex'],
                        \ s:cyan['term'], s:base03['term'], 'italic']

let g:airline#themes#test#palette.visual =
      \ airline#themes#generate_color_map(s:airline_a_visual,
                                        \ s:airline_b_visual,
                                        \ s:airline_c_visual)

let g:airline#themes#test#palette.visual['airline_z'] =
      \ [s:yellow['hex'], s:base03['hex'], s:yellow['term'], s:base03['term'],
       \ 'italic']

let g:airline#themes#test#palette.visual_modified = {
      \ 'airline_c': [s:magenta['hex'],  s:base03['hex'],
                    \ s:magenta['term'], s:base03['term'], 'italic'],
      \ }
...
let g:airline#themes#test#palette.inactive =
      \ airline#themes#generate_color_map(s:airline_a_inactive,
                                        \ s:airline_b_inactive,
                                        \ s:airline_c_inactive)
let g:airline#themes#test#palette.inactive_modified = {
      \ 'airline_c': ['#875faf', '', 97, '', ''] ,
      \ }


let g:airline#themes#test#palette.accents = {
      \ 'red': [s:red['hex'], '', s:red['term'], '']
      \ }


if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#test#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
        \ [ '#d7d7ff', '#5f00af', 189, 55 , ''    ],
        \ [ '#ffffff', '#875fd7', 231, 98 , ''    ],
        \ [ '#5f00af', '#ffffff', 55 , 231, 'italic'])
endif
