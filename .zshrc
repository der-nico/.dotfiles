...
alias pp_test="tmux capture-pane -p -S -3000 > $HOME/step_1.txt; tac $HOME/step_1.txt | grep '.' > $HOME/step_2.txt; tac $HOME/step_2.txt | grep -v ' \\$ ' > $HOME/step_3.txt; tac $HOME/step_3.txt | grep -v ' \\\$\$' > $HOME/step_4.txt; tac $HOME/step_4.txt | grep -v ^' 'nscharmb > $HOME/step_5.txt; tac $HOME/step_5.txt | pe >$HOME/tmux-buffer ; cat -n $HOME/tmux-buffer > $HOME/step_6.txt; tac $HOME/step_6.txt | sort -uk2 > $HOME/step_7.txt; tac $HOME/step_7.txt | sort -nk1 > $HOME/step_8.txt; tac $HOME/step_8.txt | cut -f2- > $HOME/tmux-buffer; cat $HOME/tmux-buffer > $HOME/step_9.txt; tac $HOME/step_9.txt | ag --nobreak --nonumbers --noheading . > $HOME/step_10.txt; tac $HOME/step_10.txt | fzf --height 20% > $HOME/step_11.txt; tac $HOME/step_11.txt | xargs echo -n > $HOME/step_12.txt; tac $HOME/step_12.txt | read a ; tmux_helper"
